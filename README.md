# The Music of Rita Jessa | Michael Angelo Pineda
...
This is a static (frontend only) website for Rita Jessa Carreon who wishes to start her music career and have a venue where she can showcase her songs, have her fans view her latest music videos and get updated with her latest events.
...
-   ### 2. Design and Typography
    ...
    -   #### a. Colour Scheme
        ...
        In addition to teal, I used [mycolor.space](https://mycolor.space/?hex=%23008080&sub=1) to find complementary colours for teal that would maintain overall aesthetic and feel of teal. The colours are listed below:
           ...
           -  #FF8749-RGB value is (255,135,73), mainly red but appears orange  
...
-   ### 3. Wireframes
    ...
    -   [Home](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/desktop-home.png)
    -   [Bio](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/desktop-bio.png)
    -   [Contact](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/desktop-contact.png)

    #### b. Tablet

    -   [Home](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/tablet-home.png)
    -   [Bio](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/tablet-bio.png)
    -   [Contact](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/tablet-contact.png)

    #### c. Mobile
    
    -   [Home](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/mobile-home.png)
    -   [Bio](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/mobile-bio.png)
    -   [Contact](https://github.com/michaelangelopineda/milestones1-singer-ritajessa/blob/master/docs/wireframes/mobile-contact.png)
